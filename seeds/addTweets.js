...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('tweets').insert({id: 19, tweet: 'unix', time_stamp: '', user_id: '9'})
    knex('tweets').insert({id: 20, tweet: 'rowValue', time_stamp: '', user_id: '4'}),
    knex('tweets').insert({id: 21, tweet: 'rowValue', time_stamp: '', user_id: '5'})
    knex('tweets').insert({id: 22, tweet: 'rowValue', time_stamp: '', user_id: '7'})
    knex('tweets').insert({id: 23, tweet: 'rowValue', time_stamp: '', user_id: '6'})
